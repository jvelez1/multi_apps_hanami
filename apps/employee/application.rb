...
module Employee
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['EMPLOYEE_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Employee::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Employee::Action is included
      ...
      # Configure the code that will yield each time Employee::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Employee::Assets::Helpers
      end
    end
