...
module Payroll
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['PAYROLL_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Payroll::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Payroll::Action is included
      ...
      # Configure the code that will yield each time Payroll::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Payroll::Assets::Helpers
      end
    end
